    ...
    <div class="container">
        <div class="team">
            <div class="section-header center">
                <h3 class="section-header--subtitle">Meet Our Team</h3>
            </div>

            
            <div class="team__content">
                <!-- Team : Marian Kushnir -->
                <div class="team__card space-between">
                    ...
                    <div class="team__card--image">
                        <img src="./images/endorsement/endoresement-client-1.jpg" alt="team photo">
                    </div>
                </div>
                ...
                <div class="team__card space-between">
                    ...
                    <div class="team__card--image">
                        <img src="./images/team/team-1.png" alt="team photo">
                    </div>
                </div>
